        ...
        <div className="text-center">
           ...
           {status !== GameStatus.IDLE && (
             <p className={`text-2xl mb-8 font-orbitron ${status === GameStatus.SUCCESS ? 'text-neon-green' : 'text-neon-pink'}`}>
               {status === GameStatus.SUCCESS ? `COMPLETED IN ${45 - timeLeft}s` : 'TIME EXPIRED'}
             </p>
           )}
        ...
        <>
          <div className="w-full max-w-4xl flex justify-between items-center mb-6">
            <div className="flex flex-col">
              <span className="text-gray-400 font-rajdhani text-sm uppercase">Time Remaining</span>
            ...
            <div className="flex flex-col items-end">
              <span className="text-gray-400 font-rajdhani text-sm uppercase">Matches</span>
